...
class Bot {
    ...
    static async checkMessage(message) {
        ...
        if (messageText && botRegex.test(messageText)) {
            ...
            return `Pesko has a construction level of ${constructionLevel} with ${formattedXp} experience. He is ${percentage} percent of the way to leveling with ${calculatedXp} experience left.`
        }
