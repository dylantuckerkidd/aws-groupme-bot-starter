...
class Bot {
    ...
    static async checkMessage(message) {
        ...
        if (messageText && botRegex.test(messageText)) {
            ...
            console.log('leftoverxp:', calculatedXp)
            console.log('percentage', percentage)
            let formattedPercentage = JSON.stringify(percentage)
            let formattedCalculatedXp = await formatNumber(calculatedXp)
            console.log('formatted percentage', formattedPercentage)
            console.log('formatted calculated xp', formattedCalculatedXp)
            ...
            return `Pesko has a construction level of ${constructionLevel} with ${formattedXp} experience, and a rank of ${formattedRank}.  He is ${formattedPercentage}% of the way to leveling.`
        }
