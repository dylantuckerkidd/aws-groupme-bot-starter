...
const handleGeneralMessage = async function (messageText) {
    if (messageText === '@jamflex') {
        return `List of current commands: @jamflex, @chart, @get [overall, attack, defence, strength, hitpoints, ranged, prayer, magic, cooking, woodcutting, fletching, fishing, firemaking, crafting, smithing, mining, herblore, agility, stickman, thieving, slayer, farming, runecrafting, hunter, construction]`
    }
