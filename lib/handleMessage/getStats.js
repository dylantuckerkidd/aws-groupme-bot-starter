...
const getSkillFromTable = require('../database/itemManipulation/getItem')
const addCurrentSkillXp = require('../database/itemManipulation/createItem')
...
const getStats = async function (messageText) {
    ...
    if (skill === undefined) {
        ...
        await addCurrentSkillXp(capitalizedTrimmedText, skillXp)
        if (skill.level > 99) {
