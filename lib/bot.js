    ...
    static async checkMessage(message) {
        ...
        if (messageText && botRegex.test(messageText)) {
            ...
            if (attackLevel === '99') {
                ...
                return `Pesko has an attack level of ${attack} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (defenceLevel === '99') {
                ...
                return `Pesko has a defense level of ${defence} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (strengthLevel === '99') {
                ...
                return `Pesko has a strength level of ${strength} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
            ...
            if (hitpointsLevel === '99') {
                ...
                return `Pesko has a hitpoints level of ${hitpoints} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (rangedLevel === '99') {
                ...
                return `Pesko has a ranged level of ${ranged} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (prayerLevel === '99') {
                ...
                return `Pesko has a prayer level of ${prayer} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (magicLevel === '99') {
                ...
                return `Pesko has a magic level of ${magic} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (cookingLevel === '99') {
                ...
                return `Pesko has a cooking level of ${cooking} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (woodcuttingLevel === '99') {
                ...
                return `Pesko has a woodcutting level of ${woodcutting} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (fletchingLevel === '99') {
                ...
                return `Pesko has a fletching level of ${fletching} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (fishingLevel === '99') {
                ...
                return `Pesko has a fishing level of ${fishing} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (firemakingLevel === '99') {
                ...
                return `Pesko has a firemaking level of ${firemaking} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (craftingLevel === '99') {
                ...
                return `Pesko has a crafting level of ${crafting} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (smithingLevel === '99') {
                ...
                return `Pesko has a smithing level of ${smithing} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (miningLevel === '99') {
                ...
                return `Pesko has a mining level of ${mining} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (herbloreLevel === '99') {
                ...
                return `Pesko has a herblore level of ${herblore} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (agilityLevel === '99') {
                ...
                return `Pesko has an agility level of ${agility} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (agilityLevel === '99') {
                ...
                return `Pesko has a stickman level of ${agility} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (thievingLevel === '99') {
                ...
                return `Pesko has a thieving level of ${thieving} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (slayerLevel === '99') {
                ...
                return `Pesko has a slayer level of ${slayer} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (farmingLevel === '99') {
                ...
                return `Pesko has a farming level of ${farming} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (runecraftingLevel === '99') {
                ...
                return `Pesko has a runecrafting level of ${runecrafting} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (hunterLevel === '99') {
                ...
                return `Pesko has a hunter level of ${hunter} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (hunterLevel === '99') {
                ...
                return `Pesko has a pawprint level of ${hunter} with ${formattedXp} experience and a rank of ${formattedRank}. He is ${percentage} percent to leveling with ${formattedCalculatedXp} experience left.`
            }
        }
