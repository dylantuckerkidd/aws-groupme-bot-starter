    ...
    static async checkMessage(message) {
        ...
        if (messageText && botRegex.test(messageText)) {
            ...
            if (attackLevel === '99') {
                ...
                return `Pesko has an attack level of ${attackLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (defenceLevel === '99') {
                ...
                return `Pesko has a defense level of ${defenceLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (strengthLevel === '99') {
                ...
                return `Pesko has a strength level of ${strengthLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
            ...
            if (hitpointsLevel === '99') {
                ...
                return `Pesko has a hitpoints level of ${hitpointsLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (rangedLevel === '99') {
                ...
                return `Pesko has a ranged level of ${rangedLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (prayerLevel === '99') {
                ...
                return `Pesko has a prayer level of ${prayerLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (magicLevel === '99') {
                ...
                return `Pesko has a magic level of ${magicLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (cookingLevel === '99') {
                ...
                return `Pesko has a cooking level of ${cookingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (woodcuttingLevel === '99') {
                ...
                return `Pesko has a woodcutting level of ${woodcuttingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (fletchingLevel === '99') {
                ...
                return `Pesko has a fletching level of ${fletchingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (fishingLevel === '99') {
                ...
                return `Pesko has a fishing level of ${fishingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (firemakingLevel === '99') {
                ...
                return `Pesko has a firemaking level of ${firemakingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (craftingLevel === '99') {
                ...
                return `Pesko has a crafting level of ${craftingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (smithingLevel === '99') {
                ...
                return `Pesko has a smithing level of ${smithingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (miningLevel === '99') {
                ...
                return `Pesko has a mining level of ${miningLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (herbloreLevel === '99') {
                ...
                return `Pesko has a herblore level of ${herbloreLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (agilityLevel === '99') {
                ...
                return `Pesko has an agility level of ${agilityLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (agilityLevel === '99') {
                ...
                return `Pesko has a stickman level of ${agilityLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (thievingLevel === '99') {
                ...
                return `Pesko has a thieving level of ${thievingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (slayerLevel === '99') {
                ...
                return `Pesko has a slayer level of ${slayerLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (farmingLevel === '99') {
                ...
                return `Pesko has a farming level of ${farmingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (runecraftingLevel === '99') {
                ...
                return `Pesko has a runecrafting level of ${runecraftingLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (hunterLevel === '99') {
                ...
                return `Pesko has a hunter level of ${hunterLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (hunterLevel === '99') {
                ...
                return `Pesko has a pawprint level of ${hunterLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
            ...
            if (constructionXp === '99') {
                ...
                return `Pesko has a construction level of ${constructionLevel} with ${formattedXp} experience. He is ${percentage} percent to to his next level with ${formattedCalculatedXp} experience left.`
            }
        }
