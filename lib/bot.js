...
class Bot {
    ...
    static async checkMessage(message) {
        ...
        if (messageText && botRegex.test(messageText)) {
            ...
            return `Pesko has a construction level of ${constructionLevel} with ${formattedXp} experience, and a rank of ${formattedRank}.  with${formattedCalculatedXp} experience to level.`
        }
