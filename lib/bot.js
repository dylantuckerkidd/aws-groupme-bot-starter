...
class Bot {
    ...
    static async checkMessage(message) {
        ...
        if (messageText && botRegex.test(messageText)) {
            ...
            let calculatedXp = await calculateExp(constructionCalculationLevel, constructionCalculationXp) 
            ...
            return `Pesko has a construction level of ${constructionLevel} with ${formattedXp} experience, and a rank of ${formattedRank}. He needs ${formattedCalculatedXp} experience to level.`
        }
